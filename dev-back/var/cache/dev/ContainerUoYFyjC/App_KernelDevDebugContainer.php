...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Admin\\OptionsCrudController' => 'getOptionsCrudControllerService',
            'App\\Controller\\Admin\\ProduitsCategorieCrudController' => 'getProduitsCategorieCrudControllerService',
            'App\\Controller\\Admin\\ProduitsCrudController' => 'getProduitsCrudControllerService',
            'App\\Controller\\TacosController' => 'getTacosControllerService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory($this->parameters['doctrine.dbal.connection_factory.types']))->createConnection(['url' => $this->getEnv('resolve:DATABASE_URL'), 'driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [], 'serverVersion' => '10.5.18', 'defaultTableOptions' => []], $a, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\ProduitsCategorieRepository' => ['privates', 'App\\Repository\\ProduitsCategorieRepository', 'getProduitsCategorieRepositoryService', true],
            ...
            'App\\Repository\\ProduitsCategorieRepository' => '?',
    ...
    protected function getHttpKernelService()
    {
        return $this->services['http_kernel'] = new \Symfony\Component\HttpKernel\HttpKernel(($this->services['event_dispatcher'] ?? $this->getEventDispatcherService()), ($this->privates['debug.controller_resolver'] ?? $this->getDebug_ControllerResolverService()), ($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), new \Symfony\Component\HttpKernel\Controller\TraceableArgumentResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver(($this->privates['argument_metadata_factory'] ?? ($this->privates['argument_metadata_factory'] = new \Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadataFactory())), new RewindableGenerator(function () {
            ...
            yield 9 => ($this->privates['debug.api_platform.argument_resolver.payload'] ?? $this->load('getDebug_ApiPlatform_ArgumentResolver_PayloadService'));
        ...
        }, 14)), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true)))));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KpcVwG+pLc', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wWF2lX9fpK', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OIyAeYsV+z', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getApiPlatform_Metadata_Resource_MetadataCollectionFactory_CachedService()
    {
        ...
        $e = ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()));
    ...
    protected function getApiPlatform_UriVariables_ConverterService()
    {
        return $this->privates['api_platform.uri_variables.converter'] = new \ApiPlatform\Api\UriVariablesConverter(($this->privates['api_platform.metadata.property.metadata_factory.cached'] ?? $this->getApiPlatform_Metadata_Property_MetadataFactory_CachedService()), ($this->privates['api_platform.metadata.resource.metadata_collection_factory.cached'] ?? $this->getApiPlatform_Metadata_Resource_MetadataCollectionFactory_CachedService()), new RewindableGenerator(function () {
            yield 0 => ($this->privates['api_platform.symfony.uri_variables.transformer.ulid'] ?? ($this->privates['api_platform.symfony.uri_variables.transformer.ulid'] = new \ApiPlatform\Symfony\UriVariableTransformer\UlidUriVariableTransformer()));
            yield 1 => ($this->privates['api_platform.symfony.uri_variables.transformer.uuid'] ?? ($this->privates['api_platform.symfony.uri_variables.transformer.uuid'] = new \ApiPlatform\Symfony\UriVariableTransformer\UuidUriVariableTransformer()));
            yield 2 => ($this->privates['api_platform.uri_variables.transformer.integer'] ?? ($this->privates['api_platform.uri_variables.transformer.integer'] = new \ApiPlatform\Api\UriVariableTransformer\IntegerUriVariableTransformer()));
            yield 3 => ($this->privates['api_platform.uri_variables.transformer.date_time'] ?? ($this->privates['api_platform.uri_variables.transformer.date_time'] = new \ApiPlatform\Api\UriVariableTransformer\DateTimeUriVariableTransformer()));
        }, 4));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wU6m4Ft4wD', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('g-OsRFUzeg', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
